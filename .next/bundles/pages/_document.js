...
function (_Document2) {
  ...
  _createClass(_Document, [{
    key: "render",
    value: function render() {
      var page = this.props["__NEXT_DATA__"].page;
      ...
      }, title, ":", " ", page.slice(1, 2).charAt(0).toUpperCase() + page.slice(1).slice(1)), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_next_document__["Head"], {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 29
        }
